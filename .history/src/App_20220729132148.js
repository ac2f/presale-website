              ...
              <div className="table-container mt-0">
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td className="has-text-right">
                        ...
                        <p className="help is-info">
                          (Do not send USDT to the private sale address. You
                    ...
                    <tr>
                      <td>Soft Cap</td>
                      <td className="has-text-right">2,500 USDT</td>
                    </tr>
                    <tr>
                      <td>Hard Cap</td>
                      <td className="has-text-right">5,000 USDT</td>
                    </tr>
                    <tr>
                      <td>Private Sale Start Time</td>
                      <td className="has-text-right">2022.07.26 19:40 (UTC)</td>
                    </tr>
                    <tr>
                      <td>Private Sale End Time</td>
                      <td className="has-text-right">2023.08.31 13:00 (UTC)</td>
                    </tr>
                    <tr>
              ...
              <form>
                ...
                <div className="pb-4">
                  ...
                  <div className="is-flex is-align-items-center is-size-7">
                    <div className="is-flex-grow-1">20.01 USDT</div>
                ...
                <div className="field">
                  <label className="label">Aasdmount </label>
              ...
              <div className="table-container">
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>Minimum Buy</td>
                      <td className="has-text-right">10 USDT</td>
                    </tr>
                    <tr>
                      <td>Maximum Buy</td>
                      <td className="has-text-right">1,000 USDT</td>
                    </tr>
                    <tr>
